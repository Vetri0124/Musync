...
export const RecorderContainer = styled.div`
    ...
    gap: 1rem; /* Space between main elements */
...
export const ResultContainer = styled.div`
    ...
    display: flex; /* Added for centering internal elements */
    flex-direction: column; /* Stack children vertically */
    ...
    img {
        ...
        display: block; /* Ensures margin auto works if not flex parent */
    ...
    .no-cover-placeholder {
        ...
        align-items: center;
        border-radius: 8px;
        margin: 0 auto 1.5rem auto; /* Centers this placeholder as well */
        color: #666;
        font-style: italic;
        font-size: 1.2rem;
    ...
    a[href*="youtube.com"] { /* Corrected selector for YouTube */
